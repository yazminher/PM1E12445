...
import com.example.pm1e12445.configuraciones.SQLiteConexion;
import com.example.pm1e12445.configuraciones.Transacciones;
import com.example.pm1e12445.Clases.Pais;
import com.example.pm1e12445.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void validarDatos() {
        ...
        }else if(telefono.getText().toString() != null && telefono.getText().toString().length() < 8){
            Toast.makeText(getApplicationContext(), "Ingrese un telefono valido" ,Toast.LENGTH_LONG).show();
        }else{
